...
This project is open-source and split into separate frontend and backend repositories. You can explore the source code here:

- **Backend (Spring Boot REST API):** [GitHub - delicious_server](https://github.com/proloypaul/delicious_server)
- **Frontend (Web Application):** [GitHub - delicious_frontend](https://github.com/proloypaul/delicious_frontend)
---
